function match(pat, obj, blists = [{}]) {
    ...
    } else if (pat && pat.hasOwnProperty("and")) {
        return matchAnd(pat["and"], obj, blists);
    } else if (pat && pat.hasOwnProperty("or")) {
        return matchOr(pat["or"], obj, blists);
    } else if (pat && pat.hasOwnProperty("not")) {
        return matchNot(pat["not"], obj, blists);
    } else if (pat && pat.hasOwnProperty("some")) {
        return matchSome(pat["some"], obj, blists);
    } else if (pat && pat.hasOwnProperty("contains")) {
        return matchContains(pat["contains"], obj, blists);
    } else if (pat && pat.hasOwnProperty("reg")) {
...
// doesn't know whether previous binding lists matter or not.
