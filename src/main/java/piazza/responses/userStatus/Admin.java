...
public class Admin {
    ...
    @JsonProperty("can_post_anonymous_all")
    private Boolean canPostAnonymousAll;
    ...
    @JsonProperty("can_post_anonymous_all")
    public Boolean getCanPostAnonymousAll() {
        return canPostAnonymousAll;
    }

    @JsonProperty("can_post_anonymous_all")
    public void setCanPostAnonymousAll(Boolean canPostAnonymousAll) {
        this.canPostAnonymousAll = canPostAnonymousAll;
    }
